import { createChart, CandlestickSeries, LineSeries, HistogramSeries } from "./node_modules/lightweight-charts/dist/lightweight-charts.standalone.development.mjs";
async function fetchJSONData() {
    ...
    const symbol = ohlcvJSON["symbol"];
    const ohlcvData = ohlcvJSON["data"];
...
function createSeriesFromString(chart, color) {
    return chart.addSeries(LineSeries, { color: color });
}
function renderOhlcv(chart, ohlcvData) {
